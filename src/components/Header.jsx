...
import logoShopee from "../assets/img/logo-shopee.jpg";
import shopeeHoanXu from "../assets/img/shopee-hoan-xu.jpg";
import shopeeFood from "../assets/img/shopee-food.png";
    ...
    <header className="header">
      <div className="grid wide">
        <nav className="header__navbar hide-on-mobile-tablet">
            ...
            <li className="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
              ...
              <div className="header__qr">
                ...
                <div className="header__qr-apps">
                  <Link to="/" className="header__qr-apps-link">
                    <img
                      src={appleStore}
                      alt="App Store"
          ...
          <ul className="header__navbar-list">
                    ...
                    <Link to="/" className="header__notify-link">
                      ...
                      <div className="header__notify-info">
                        <span className="header__notify-name">
                          Quét QR - Săn loạt sales chỉ 1Đ
                        </span>
                        <span className="header__notify-description">
                          Phúc Long, MiniStop, Vựa Hải Sản Xanh, GS25, Thêm
                          nhiều vocher khác nữa.
                        </span>
                      </div>
                    </Link>
                  </li>
                  ...
                  <li className="header__notify-item">
                    <Link to="/" className="header__notify-link">
                      ...
                      <div className="header__notify-info">
                        ...
                        <span className="header__notify-description">
                          Phúc Long, MiniStop, Vựa Hải Sản Xanh, GS25, Thêm
                          nhiều vocher khác nữa. Phúc Long, MiniStop, Vựa Hải
                          Sản Xanh, GS25, Thêm nhiều vocher khác nữa. Phúc Long,
                          MiniStop, Vựa Hải Sản Xanh, GS25, Thêm nhiều vocher
                          khác nữa.
                        </span>
                      </div>
                    </Link>
            ...
            <Link
              to={"/admin"}
              className="header__navbar-item header__navbar-item--register header__navbar-item--separate"
            >
              ADMIN
            </Link>
          </ul>
        ...
        <div className="header-with-search">
          <label
            ...
            htmlFor="header__moblie-checkbox"
          >
            <i className="header__mobile-search-icon fas fa-search" />
          </label>
          <input type="checkbox" id="header__moblie-checkbox" hidden />
      ...
      <ul className="header__sort-bar">
        <li className="header__sort-item">
          <Link
            to="/admin"
            className="header__sort-link header__sort-link--active"
          >
            Admin
          </Link>
        </li>
        <li className="header__sort-item">
          <Link to="/admin" className="header__sort-link">
            Admin
          </Link>
        </li>
        <li className="header__sort-item">
