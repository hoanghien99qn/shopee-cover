    ...
    <>
      ...
      <div className="col l-2-4 m-4 c-6 product-item">
        ...
        <div className="product-item-contain">
          <Link
            to={`/detail/${item.collectionId}/${item.id}`}
          ...
          >
            ...
            <div className="product-item-price">
              {item.price !== currentPrice && (
                <div className="product-item-price--old-price">
                  {oldPriceFormat}
                </div>
              )}
              <div className="product-item-price-current-price">
                {currentPriceFormat}
              </div>
            </div>
            <div className="product-item-actions">
              ...
              <div className="product-item-actions-rating">
                <i
                  className={`fas fa-star ${item.vote >= 1 ? "active" : ""}`}
                />
                <i
                  className={`fas fa-star ${item.vote >= 2 ? "active" : ""}`}
                />
                <i
                  className={`fas fa-star ${item.vote >= 3 ? "active" : ""}`}
                />
                <i
                  className={`fas fa-star ${item.vote >= 4 ? "active" : ""}`}
                />
                <i
                  className={`fas fa-star ${item.vote >= 5 ? "active" : ""}`}
                />
              </div>
            </div>
            ...
            {item.saleOff > 0 && (
              <div className="product-item-sale-off">
                <span className="product-item-sale-off__percent">
                  {item.saleOff}%
                </span>
          ...
          <div className="action-btn">
            <button className="edit-btn btn-ad" onClick={handleOpenModalEdit}>
              Edit
            </button>
            <button className="delete-btn btn-ad" onClick={handleDeleteProduct}>
              Delete
            </button>
          </div>
        </div>
